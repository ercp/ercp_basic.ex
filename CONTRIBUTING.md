# Contributing to ercp_basic.ex

`ercp_basic.ex` is written in [Elixir](https://elixir-lang.org).
...
2. Clone your fork to a local repository:
        ...
        $ git clone https://github.com/you/ercp_basic.ex.git
        $ cd ercp_basic.ex

3. Add the main repository as a remote:

        $ git remote add upstream https://github.com/ercp/ercp_basic.ex.git
